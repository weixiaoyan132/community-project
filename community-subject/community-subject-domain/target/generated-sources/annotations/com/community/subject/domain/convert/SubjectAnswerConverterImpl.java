...
public class SubjectAnswerConverterImpl implements SubjectAnswerConverter {
    ...
    @Override
    public List<SubjectAnswerBO> convertRadioListToBOList(List<SubjectRadio> subjectRadioList) {
    ...
    @Override
    public List<SubjectAnswerBO> convertMultipleListToBOList(List<SubjectMultiple> subjectMultipleList) {
    ...
    @Override
    public List<SubjectAnswerBO> convertJudgeListToBOList(List<SubjectJudge> subjectJudgeList) {
