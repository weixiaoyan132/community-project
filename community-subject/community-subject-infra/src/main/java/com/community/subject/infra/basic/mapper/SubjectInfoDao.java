package com.community.subject.infra.basic.mapper;
...
//    List<SubjectInfo> queryAllByLimit(SubjectInfo subjectInfo, @Param("pageable") Pageable pageable);
    ...
    List<SubjectInfo> queryPageByCondition(@Param("subjectInfo") SubjectInfo subjectInfo,@Param("categoryId") Long categoryId,@Param("labelId") Long labelId,@Param("start") Integer start,@Param("pageSize") Integer pageSize);
}
